(() => {
  ...
  function injectStyle() {
    ...
    style.textContent = `
      ...
      .office-telegram-copy{display:flex;align-items:center;gap:13px;min-width:0}.office-telegram-icon{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:rgba(198,245,45,.12);color:#c6f52d;font-size:18px;flex:0 0 auto}.office-telegram-copy h3{margin:0;font-size:13px;color:#edf1ec}.office-telegram-copy p{margin:4px 0 0;font-size:10px;line-height:1.5;color:#7f8991}.office-telegram-status{font-size:9px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;margin-top:5px}.office-telegram-status.connected{color:#c6f52d}.office-telegram-status.pending{color:#e6b65b}.office-telegram-status.disconnected{color:#ff9f8a}.office-telegram-action{border:1px solid #c6f52d;background:#c6f52d;color:#0a0d11;border-radius:10px;padding:10px 14px;font-size:10px;font-weight:800;white-space:nowrap;cursor:pointer}.office-telegram-action:disabled{opacity:.6;cursor:wait}.office-telegram-static{font-size:9px;color:#c6f52d;font-weight:800;white-space:nowrap}
  ...
  function render(telegram, sb) {
    ...
    card.innerHTML = `
      ...
      ${connected ? '<span class="office-telegram-static">CONNECTED</span>' : '<button class="office-telegram-action" id="officeTelegramConnect">Connect Telegram</button>'}
    `;
